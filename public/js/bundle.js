...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FpZG5hZGVyMTk4NyIsImEiOiJjbHFlOGdvY3MwYjhzMmpxeXI3eGliNDZoIn0.0gDozjH2JmR8p3LlCDTOKQ';
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */ // dissable eslint because we have it configured with node js code not javascript code, so that it doesnt give us an error
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            // it will try to fetch it from the same server that served the page
            data: {
              email: email,
              password: password
            }
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', _context.t0.response.data.message); // this err.response.data is from axios documentation
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', 'Error loggint out. Try again');
        case 11:
        case "end":
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
// Public key
var stripe = Stripe('pk_test_51OScg5CuMHqfKqZWtOUyDOQIHvI11iodCfUFbF0c7GeyTZaDRV2XQtdVm1PIxTS4xoKCJK9aNtVHteiEXmQ0UBww00D6pnCAdJ');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          // for get requests we only need to specify the url without the method
          console.log(session);
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // creating a multipart form data
